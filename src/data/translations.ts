export const translations = {
  en: {
    ...
    features: {
      ...
      backendSub: "ASP.NET Core",
      frontend: "Modern Frontend",
      frontendSub: "React & TypeScript",
      cloud: "Cloud Native",
      cloudSub: "Azure & Docker",
    },
    skills: {
      title: "Skills",
      subtitle: "Core technologies I use to build applications.",
    },
    focus: {
      title: "What I Focus On When Building Applications",
      items: [
        {
  ...
  pl: {
    ...
    skills: {
      title: "Umiejętności",
      subtitle: "Główne technologie, których używam do budowania aplikacji.",
    },
    focus: {
      title: "Na czym skupiam się tworząc aplikacje",
      items: [
        {
    ...
    contact: {
      title: "Kontakt",
      subtitle: "Zainteresowany współpracą?",
      description: "Stwórzmy razem coś wspaniałego.",
      button: "Wyślij do mnie email",
    },
  },
};
